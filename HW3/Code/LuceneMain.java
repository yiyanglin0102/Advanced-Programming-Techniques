...
//			Directory index = new ByteBuffersDirectory();
			FSDirectory index = FSDirectory.open(Paths.get("/Users/yiyanglin/Desktop/CS622/CS622/HW3/DATA/"));
			IndexWriterConfig config = new IndexWriterConfig(analyzer);
			IndexWriter w = new IndexWriter(index, config);

			FileReader inputFile = new FileReader("/Users/yiyanglin/Desktop/CS622/CS622/HW3/200.xml");
