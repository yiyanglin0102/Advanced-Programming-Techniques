...
//			Directory index = new ByteBuffersDirectory();
			FSDirectory index = FSDirectory.open(Paths.get("/Users/yiyanglin/Desktop/HW6/DATA/"));
			IndexWriterConfig config = new IndexWriterConfig(analyzer);
			IndexWriter w = new IndexWriter(index, config);

			FileReader inputFile = new FileReader("/Users/yiyanglin/Desktop/HW6/sample.xml");
